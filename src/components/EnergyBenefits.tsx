    ...
    <div className={`space-y-12 mt-${marginTop} px-${marginX}`}>
      {benefits.map((benefit, index) => {
        ...
        return (
          <div
            key={index}
            className={`flex flex-col md:flex-row items-center min-h-[35rem] px-[4.5rem] rounded-xl bg-white shadow-md overflow-hidden ${
          ...
          >
            ...
            <div className="w-full md:w-1/2 h-full flex justify-center items-center">
              <img
                className="w-auto h-64 rounded-lg flex items-center justify-center text-white text-xl font-semibold object-cover"
                src={benefit.image}
              />
            </div>

            {/* Text Content */}
            <div className="w-full md:w-1/2 h-full flex flex-col justify-center items-start text-left p-6 space-y-4">
