...
const Menu = ({ setIsClicked }: { setIsClicked: (value: boolean) => void }) => {
  ...
  return (
    <div className="absolute flex flex-col justify-start items-end pt-18 pr-18 gap-6 w-full top-25 h-screen left-0 z-50 bg-blue-400/96 text-white delay-300 ease-in-out duration-300">
